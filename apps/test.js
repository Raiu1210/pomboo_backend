...
// curl -X POST -H "Content-Type: application/json" -d '{"email":"test7@gmail.com", "password":"oppai", "latitude":40.587290, "longitude":140.465143, "permission":1}' localhost:3000/update_location
...
// // (1) add relation
// curl -X POST -H "Content-Type: application/json" -d '{"email":"test7@gmail.com", "password":"oppai", "request_code":1, "level":1, "give_id":1}' localhost:3000/relation
